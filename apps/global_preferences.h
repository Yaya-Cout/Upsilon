...
public:
  ...
  bool extapp_showed() const { return m_extapp_showed; }
  void setExtapp_showed(bool extapp_showed) { m_extapp_showed = extapp_showed; }
private:
